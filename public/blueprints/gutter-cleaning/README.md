# ClearFlow Gutter Care

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/gutter-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page gutter cleaning service homepage using core blocks only.
...
- Uses the `risk-prevention` layout archetype.
