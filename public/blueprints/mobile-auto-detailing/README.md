# ShineShift Mobile Detail

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/mobile-auto-detailing/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page mobile auto detailing service homepage using core blocks only.
...
- Uses the `fixed-bottom-action` layout archetype.
