...
Use `public/blueprints/lawn-care-service/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image and favicon in the PHP setup step.
...
- Uses the `lawn-route-status-board` layout archetype.
