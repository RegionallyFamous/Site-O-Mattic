# SpritzLoop Beverage Cart

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/mocktail-beverage-cart/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page mocktail and beverage cart service homepage using core blocks only.
...
- Uses the `mocktail-cart-menu` layout archetype.
