...
Use `public/blueprints/senior-downsizing-move-prep/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page senior downsizing and move prep service homepage using core blocks only.
...
- Uses the `story-card-consult` layout archetype.
