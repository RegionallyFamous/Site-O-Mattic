# FrameForge Headshots

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/headshot-brand-photography/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page headshot and brand photography studio homepage using core blocks only.
...
- Uses the `headshot-proof-gallery` layout archetype.
