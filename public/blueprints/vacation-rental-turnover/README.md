...
Use `public/blueprints/vacation-rental-turnover/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page vacation rental turnover cleaning service homepage using core blocks only.
...
- Uses the `turnover-receipt-board` layout archetype.
