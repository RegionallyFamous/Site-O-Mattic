...
Use `public/blueprints/pool-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page pool cleaning service homepage using core blocks only.
...
- Uses the `water-test-board` layout archetype.
