...
Use `public/blueprints/junk-removal-donation-hauling/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page junk removal and donation hauling service homepage using core blocks only.
...
- Uses the `side-rail-service` layout archetype.
