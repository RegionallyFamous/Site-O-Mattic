...
Use `public/blueprints/window-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image and favicon in the PHP setup step.
