# ClearPane Window Care

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/window-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page window cleaning service homepage using core blocks only.
...
- Uses the `window-scope-ledger` layout archetype.
