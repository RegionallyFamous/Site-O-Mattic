# Linen & Lantern Setups

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/picnic-proposal-setup/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page picnic and proposal setup service homepage using core blocks only.
...
- Uses the `picnic-proposal-lookbook` layout archetype.
