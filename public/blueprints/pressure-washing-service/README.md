# BrightJet Exterior Cleaning

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/pressure-washing-service/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page pressure washing and soft washing service homepage using core blocks only.
...
- Uses the `before-after-quote` layout archetype.
