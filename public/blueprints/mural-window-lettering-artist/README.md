...
Use `public/blueprints/mural-window-lettering-artist/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page mural and window lettering artist homepage using core blocks only.
...
- Uses the `mural-lettering-workshop` layout archetype.
