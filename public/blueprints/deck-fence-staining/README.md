...
Use `public/blueprints/deck-fence-staining/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page deck and fence staining service homepage using core blocks only.
...
- Uses the `deck-finish-sample-board` layout archetype.
