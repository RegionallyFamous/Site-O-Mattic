...
Use `public/blueprints/micro-wedding-florals/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page micro-wedding floral design homepage using core blocks only.
...
- Uses the `micro-wedding-floral-story` layout archetype.
