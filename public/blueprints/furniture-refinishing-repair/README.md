# GrainMend Furniture Co.

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/furniture-refinishing-repair/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page furniture refinishing and repair service homepage using core blocks only.
...
- Uses the `furniture-refinish-proof` layout archetype.
