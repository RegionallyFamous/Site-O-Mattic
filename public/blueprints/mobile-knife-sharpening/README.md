# EdgeRoute Sharpening

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/mobile-knife-sharpening/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page mobile knife sharpening service homepage using core blocks only.
...
- Uses the `sharp-route-bench` layout archetype.
