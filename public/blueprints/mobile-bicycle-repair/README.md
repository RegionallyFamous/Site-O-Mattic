# TuneLoop Bike Repair

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/mobile-bicycle-repair/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page mobile bicycle repair service homepage using core blocks only.
...
- Uses the `bike-route-workstand` layout archetype.
