# RidgeGlow Holiday Lights

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/holiday-light-installation/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page holiday light installation service homepage using core blocks only.
...
- Uses the `urgent-checklist` layout archetype.
