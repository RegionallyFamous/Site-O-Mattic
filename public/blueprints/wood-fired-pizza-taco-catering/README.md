...
Use `public/blueprints/wood-fired-pizza-taco-catering/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page wood-fired pizza and taco pop-up catering homepage using core blocks only.
...
- Uses the `street-food-menu-board` layout archetype.
