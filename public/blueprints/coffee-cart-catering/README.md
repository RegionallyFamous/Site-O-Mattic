# Cartwright Coffee Co.

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/coffee-cart-catering/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page coffee cart catering service homepage using core blocks only.
...
- Uses the `package-menu-board` layout archetype.
