...
Use `public/blueprints/solar-panel-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page solar panel cleaning service homepage using core blocks only.
...
- Uses the `service-receipt-stack` layout archetype.
