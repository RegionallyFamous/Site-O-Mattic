...
Use `public/blueprints/garage-organization/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page garage organization service homepage using core blocks only.
...
- Uses the `zone-grid-planner` layout archetype.
