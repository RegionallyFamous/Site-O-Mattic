# FlashDash Photo Booth

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/photo-booth-rental/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page photo booth rental service homepage using core blocks only.
...
- Uses the `photo-booth-strip-packages` layout archetype.
