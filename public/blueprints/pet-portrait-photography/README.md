...
Use `public/blueprints/pet-portrait-photography/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page pet portrait photography studio homepage using core blocks only.
...
- Uses the `pet-portrait-gallery` layout archetype.
