# HueHaus Color Studio

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/interior-color-consultant/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page interior color consultant homepage using core blocks only.
...
- Uses the `color-consult-story` layout archetype.
