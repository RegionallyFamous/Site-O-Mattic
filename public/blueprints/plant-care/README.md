...
Use `public/blueprints/plant-care/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page houseplant and office plant care service homepage using core blocks only.
...
- Uses the `route-led-schedule` layout archetype.
