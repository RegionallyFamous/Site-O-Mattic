# SignalNest Home Setup

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/smart-home-setup/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page smart home and home theater setup service homepage using core blocks only.
...
- Uses the `side-rail-estimate` layout archetype.
