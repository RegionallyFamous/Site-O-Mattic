# Sugarline Dessert Co.

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/dessert-table-bakery-catering/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page dessert table and bakery catering homepage using core blocks only.
...
- Uses the `dessert-table-gallery` layout archetype.
