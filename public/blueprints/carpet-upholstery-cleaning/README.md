# FreshThread Fabric Care

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/carpet-upholstery-cleaning/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page carpet and upholstery cleaning service homepage using core blocks only.
...
- Uses the `stain-care` layout archetype.
