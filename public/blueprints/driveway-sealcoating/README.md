# Blackline Sealcoating

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/driveway-sealcoating/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page driveway sealcoating service homepage using core blocks only.
...
- Uses the `surface-seasonal` layout archetype.
