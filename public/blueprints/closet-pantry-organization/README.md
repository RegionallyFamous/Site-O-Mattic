# Shelfwise Organizing

Generated WordPress Studio / Playground Blueprint.

## Import

Use `public/blueprints/closet-pantry-organization/blueprint.json` as the Studio-ready Blueprint file. It is self-contained and embeds the hero image, logo, and favicon in the PHP setup step.
...
- Creates a one-page closet and pantry organization service homepage using core blocks only.
...
- Uses the `organizing-zone-board` layout archetype.
