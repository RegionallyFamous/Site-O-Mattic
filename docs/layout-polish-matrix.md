...
- Visual QA should record first-viewport proof/action evidence: text brand, H1, proof cue, primary CTA, service media, next-section peek, fixed dock/footer overlap, and proof-card alignment. Add 360px, 390px, 430px, 768px, 1024px, and desktop checks when sticky, side-rail, table, or mobile dock patterns are active.
