...
$global_styles_post_name = 'wp-global-styles-' . get_stylesheet();
$existing_styles = get_page_by_path($global_styles_post_name, OBJECT, 'wp_global_styles');

$global_styles_post = [
    'post_title' => 'Custom Styles',
    'post_name' => $global_styles_post_name,
...
if ($existing_styles instanceof WP_Post) {
    $global_styles_post['ID'] = $existing_styles->ID;
    $global_styles_id = wp_update_post($global_styles_post);
} else {
    $global_styles_id = wp_insert_post($global_styles_post);
}
...
<!-- wp:site-logo {"width":74,"shouldSyncIcon":true} /-->
...
<!-- wp:cover {"url":"{{hero_url}}","id":{{hero_id}},"dimRatio":38,"overlayColor":"deep-green","isUserOverlayColor":true,"minHeight":760,"minHeightUnit":"px","contentPosition":"center left","align":"full","style":{"spacing":{"padding":{"top":"80px","right":"24px","bottom":"90px","left":"24px"}}}} -->
<div class="wp-block-cover alignfull has-custom-content-position is-position-center-left" style="padding-top:80px;padding-right:24px;padding-bottom:90px;padding-left:24px;min-height:760px"><span aria-hidden="true" class="wp-block-cover__background has-deep-green-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-{{hero_id}}" alt="" src="{{hero_url}}" data-object-fit="cover" data-object-position="68% 50%"/><div class="wp-block-cover__inner-container">
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"textColor":"white","style":{"typography":{"fontSize":"clamp(52px, 8vw, 104px)","lineHeight":"0.94","fontStyle":"normal","fontWeight":"900"},"spacing":{"margin":{"top":"12px","bottom":"22px"}}}} -->
<h1 class="wp-block-heading has-white-color has-text-color" style="margin-top:12px;margin-bottom:22px;font-size:clamp(52px, 8vw, 104px);font-style:normal;font-weight:900;line-height:0.94">${esc(copy.heroTitle)}</h1>
<!-- /wp:heading -->
