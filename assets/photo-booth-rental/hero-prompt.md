# FlashDash Photo Booth hero image prompt

Photo booth rental event corner with kiosk, ring light, guests, attendant, props, wide 16:9 with left negative space, no readable text or logos.
...
Production art direction note: show an active photo booth rental service service moment with visible proof or finished outcome tied to open-air photo booth in use with attendant, guests, props table, lit kiosk, and event backdrop. Keep it in a believable local home, room, workshop, office, event venue, outdoor route, garden, driveway, roofline, or cart environment as appropriate; frame a wide 16:9 landscape hero with copy-safe negative space for a headline overlay on one side and the service evidence in the opposite focal zone. Use soft natural light or warm event light, include relevant tools, materials, surface textures, and equipment from the scene (An open-air photo booth setup with guests, an attendant, ring light, props, and a soft event backdrop), and avoid readable text, logos, brand marks, watermark artifacts, distorted hands, broken tools, and over-polished stock staging.
